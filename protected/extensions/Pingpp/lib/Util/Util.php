...
namespace application\extensions\Pingpp\lib\Util;

use application\extensions\Pingpp\Object;
use stdClass;
...
abstract class Util
{
    ...
    public static function convertToPingppObject($resp, $opts)
    {
        ...
        $types = array(
            'red_envelope'=>'application\\extensions\\Pingpp\\lib\\RedEnvelope',
            'charge' => 'application\\extensions\\Pingpp\\lib\\Charge',
            'list' => 'application\\extensions\\Pingpp\\lib\\Collection',
            'refund' => 'application\\extensions\\Pingpp\\lib\\Refund',
            'event' => 'application\\extensions\\Pingpp\\lib\\Event',
            'transfer' => 'application\\extensions\\Pingpp\\lib\\Transfer',
            'customer' => 'application\\extensions\\Pingpp\\lib\\Customer',
            'card' => 'application\\extensions\\Pingpp\\lib\\Card',
            'sms_code' => 'application\\extensions\\Pingpp\\lib\\SmsCode',
            'card_info' => 'application\\extensions\\Pingpp\\lib\\CardInfo',
            'token' => 'application\\extensions\\Pingpp\\lib\\Token'
        );
        if (self::isList($resp)) {
            $mapped = array();
            foreach ($resp as $i)
            ...
            if (isset($resp->object) 
                ...
                && isset($types[$resp->object])) {
                    ...
                    $class = 'application\\extensions\\Pingpp\\lib\\Object';
                }

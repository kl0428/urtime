...
class Snoopy
{
	...
	public $agent = "Mozilla/5.0"; // agent we masquerade as
	...
	public $maxredirs = 0;     // http redirection depth maximum. 0 = disallow
	...
	public $read_timeout = 60;     // timeout on read operations, in seconds
	// supported only since PHP 4 Beta 4
	// set to 0 to disallow timeouts
	public $timed_out = true;    // if a read operation timed out
	...
	public $_fp_timeout = 5;     // timeout for socket connection
